...
public sealed partial class MainWindow
{
    ...
    private async Task BuildApprovedSiblingAsync()
    {
        ...
        SearchStatusText.Text = "Building cumulatively from Current ENG compressed blocks; pristine JP remains the structural/reference authority; canonical sources remain read only…";
