...
/// <summary>
/// Regression for the 2026-09-12 donor-whole-XET defect, now exercised as an
/// explicit pristine-restore transaction rather than the normal incremental path.
/// </summary>
internal static class TargetShellRegression
{
    ...
    internal static void Run()
    {
        ...
        Assert(PixelEqual(finalDecoded, pristineDecoded, damagedPixel),
            "explicit restore mode repairs unrelated damaged target block from pristine compressed artwork");
        Assert(tx.Audit.UsedPristineOverride, "audit records explicit pristine restore mode");
        ...
        Console.WriteLine("PASS target-shell restore regression transaction");
    }
