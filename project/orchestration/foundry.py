...
def build_parser():
    ...
    tr=sub.add_parser("triage",help="Prioritize divergent providers by route/family, consensus and tree contamination"); tr.add_argument("snapshot"); tr.add_argument("--limit",type=int); tr.add_argument("--actionable",action="store_true"); tr.add_argument("--verbose",action="store_true",help="Include every provider instead of concise summaries/outliers"); tr.set_defaults(func=triage_command)
