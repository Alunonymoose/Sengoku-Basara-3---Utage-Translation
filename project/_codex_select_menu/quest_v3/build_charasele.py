...
(W/'charasele_v3.tex').write_bytes(out);preview(unpack_color(decode(out)),W/'CHARASELE_V3_PREVIEW.png');(W/'CHARASELE_BUILD.json').write_text(json.dumps(dict(source_sha256=arc.sha256(raw),sha256=arc.sha256(out),cells=reports),indent=2))
