...
O=Path(r'E:\Utage Patching New\_codex_select_menu\quest_v7');a=arc.parse_arc(Path(r'E:\SAMURAI HEROES\PS3_GAME\USRDIR\nativePS3\rom\eng\tenka\smith.arc'))
for e in a.entries:
 if e.type_hash!=0x10c460e6:continue
 ...
 (O/f'donor_shop_{e.index}.json').write_text(json.dumps(rows,indent=2));print(e.index,n,rows[:3]);print(rows[324:337])
