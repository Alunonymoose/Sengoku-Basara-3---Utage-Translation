...
class AlrummiV41App(v4.AlrummiV4App):
    def __init__(self):
        ...
        super().__init__()
        self.title("Alrummi 3 V4.1 — Utage Texture Fixer")
        try:
    ...
    def _v4_ai_rebuild(self, report, key):
        ...
        try:
            ...
            if not quality["accepted"]:
                ...
                fallback["ai_error"] = "AI candidate rejected: " + "; ".join(quality["reasons"])
                fallback["candidate_quality"] = quality
                fallback["donor_rejections"] = report.get("donor_rejections", [])
                return fallback
            return {
                "route": "v4_ai",
                "image": image,
    ...
    def _v4_offline_rebuild(self, report):
        result = super()._v4_offline_rebuild(report)
        result["donor_rejections"] = report.get("donor_rejections", [])
        return result
